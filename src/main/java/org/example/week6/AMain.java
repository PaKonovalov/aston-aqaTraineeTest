...
import static org.example.week6.Singleton.Baseclass.driver;
...
public class AMain {
    ...
    public static void main(String[] args) {
        ...
        googleDriver.close();
        googleDriver.quit();
        googleDriver.getTitle();         //Получаетзаголовок текущей страницы
        ...
        googleDriver.getWindowHandles(); // getWindowHandle()
        ...
        //TODO Методы класса By
        googleDriver.findElement(By.xpath("")); //name(), className(), tagName(), cssSelector(), linkText()
       ...
       WebElement element = (new WebDriverWait(googleDriver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(             //в методе until указываем чего мы ждем,
                                                                                ...
                                                                                //нужно дожаться исчезновения элемента
       ...
       element.click();
        ...
        //TODO Expected Conditions
        //TODO Виды explicitly wait
        //Используется в явных ожиданиях
        //WebElement element1 = (new WebDriverWait(googleDriver, Duration.ofSeconds(10))
                //.until(ExpectedConditions
                        //.attributeContains(webElement,"","")       //атрибут сожержит что-то нонкретное
                        ...
                        //.numberOfElementsToBe()                    //ожидание колличесва элементов..
        ...
        Duration pageLoadTimeout = googleDriver.manage().timeouts()
                .implicitlyWait(Duration.ofSeconds(10))     //ожидания появления элемента на странице или ао времени
